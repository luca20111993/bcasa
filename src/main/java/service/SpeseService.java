...
public class SpeseService {
    ...
    public Double sumAllSpese7GG() {
        ...
        double res = em.createNamedQuery(Spese.SUM_ALL_SPESE_7_GG , Double.class).
                setParameter("dat", dataoggi).
                setParameter("ut", ut).
                setParameter("dat2", FunzioniData.converti(minus)).
                getSingleResult();
    ...
    public Double sumAllSpese1Mese( /*Long id*/) {
        Utenti ut = utenteLogged.getUtenteLogged();
        Date dataoggi = new Date();
        ...
        cal.add(Calendar.DATE, -31);
        Date dateBefore31Days = cal.getTime();*/
        return em.createNamedQuery(Spese.SUM_ALL_SPESE_1_MESE, Double.class).
                setParameter("dat", dataoggi).
                setParameter("ut", ut).
                setParameter("dat2", FunzioniData.converti(minus)).
                getSingleResult();
