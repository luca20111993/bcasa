...
<html>
    <head>
        ...
        <link href="CssFolder/Spese_31_ggCss.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <div id="maindiv">
            ...
            <div id="title">Le spese degli ultimi 31 giorni!</div>
            ...
            <tr>
                ...
                <div>
                    <c:set  value="${speseSrv.sumAllSpese1Mese()}" var="bu"/>
                    <div id="Tot">Spesa totale : <c:out value="${bu}"/></div>
